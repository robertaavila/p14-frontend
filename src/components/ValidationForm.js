            ...
            <div className="column ">
                ...
                <div className="tile box">
                    <div className="tile is-parent is-half">
                        <div className="column has-text-left box mr-2">
                                    ...
                                    <div className="field">
                                        ...
                                        <div className="control">
                                            <div className="select">
                                                <select>
                                                    <option>Selecione</option>
                                                    {this.state.modalidade.map((v) => <option>{v.nome}</option>)}
                                        ...
                                        <div className="control">
                                            <div className="select">
                                                <select>
                                                    <option>Selecione</option>
                                                    {this.state.atividades.map((v) => <option>{v.nome}</option>)}
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="column has-text-left box ml-2">
                            <div className="field">
                                ...
                                <div className="control has-icons-left has-icons-right">
                                    <input className="input is-success" type="text" placeholder="Text input"></input>
